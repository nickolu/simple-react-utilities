...
ncUtilities = function() {
   ...
   */
  pub.getObjectByName = function(arr,name) {
    let i = 0;
    for (i in arr) {
      if ('name' in arr[i]) {
        if (arr[i].name === name) {
   ...
   */
  pub.getObjectsByProp = function(arr,propName,val,usePartialMatch) {
    let i = 0;
    let objects = [];
    let _this = this;
   ...
   */
  pub.countItemInArray = function(arr,item) {
    let l = arr.length;
    let i = 0;
  ...
  /**
     ...
     */
  pub.removeObject = function(arr,obj) {
    var i;
    var l = arr.length;
    var prop;
   ...
   */
  pub.sortObjectsByProp = function (objects,prop) {
    var i;
   ...
   */
  pub.getArrayFromObject = function(data,key,returnString) {
    var items = [];
   ...
   */
  pub.getModifier = function(score) {
   ...
   */
  pub.getAbilityScoreModifier = function(num) {
